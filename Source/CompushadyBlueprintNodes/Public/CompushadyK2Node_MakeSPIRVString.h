...
#include "CompushadyK2Node_MakeSPIRVString.generated.h"

/**
 * 
 */
UCLASS()
class COMPUSHADYBLUEPRINTNODES_API UCompushadyK2Node_MakeSPIRVString : public UCompushadyK2Node_MakeStringBase
{
	GENERATED_BODY()
