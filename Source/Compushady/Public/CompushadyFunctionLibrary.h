...
public:
	...
	UFUNCTION(BlueprintCallable, meta = (AutoCreateRefTerm = "ResourceMap,BlendableRasterizerConfig"), Category = "Compushady")
	static UCompushadyBlendable* CreateCompushadyComputeBlendableByMapFromHLSLString(const FString& ShaderSource, const TMap<FString, TScriptInterface<ICompushadyBindable>>& ResourceMap, FString& ErrorMessages, const FCompushadyBlendableRasterizerConfig& BlendableRasterizerConfig, const FIntVector& XYZ, const FString& ShaderEntryPoint = "main", const ECompushadyPostProcessLocation PostProcessLocation = ECompushadyPostProcessLocation::AfterTonemapping);

	UFUNCTION(BlueprintCallable, meta = (AutoCreateRefTerm = "ResourceMap,BlendableRasterizerConfig,FileLoaderConfig"), Category = "Compushady")
