...
This plugin exposes features like runtime shaders loading, conversion and compilation (HLSL and GLSL are supported, but if you are brave you can even assemble from SPIRV too), reflection, fast copies (for both Textures and Buffers) and integration with various Unreal Assets (like MediaTextures, Curves, StaticMeshes...).
